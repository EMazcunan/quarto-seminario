...
# Quarto desde R Markdown {background-color=var(--presentation-heading-color)}

## [Announcing Quarto](https://posit.co/blog/announcing-quarto-a-new-scientific-and-technical-publishing-system/)
...
# Quarto desde {{< latex >}} {background-color=var(--presentation-heading-color)}
...
# {data-menu-title="Gracias" visibility="uncounted" background-color=var(--presentation-heading-color)}
